...
// анимация для вращения часов
        Animation clockTurnAnimation = AnimationUtils.loadAnimation(this, R.anim.clock_tern);
...
// присоединяем анимацию
        ...
        Animation catTurnAnimation = AnimationUtils.loadAnimation(this, R.anim.cat);
    }
}